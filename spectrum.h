...
namespace Spectrum {
    ...
    namespace Static { // static colors
        ...
        const unsigned int GREY200 = Color(0xF4F4F4);
        const unsigned int GREY300 = Color(0xEAEAEA);
        const unsigned int GREY400 = Color(0xD3D3D3);
        const unsigned int GREY500 = Color(0xBCBCBC);
        const unsigned int GREY600 = Color(0x959595);
        const unsigned int GREY700 = Color(0x767676);
        const unsigned int GREY800 = Color(0x505050);
        const unsigned int GREY900 = Color(0x323232);
